...
if ( ! \class_exists( 'J7\Woocommerce_Pdf_Invoices_Packing_Slips_Extend_TC\Plugin' ) ) {
	...
	final class Plugin extends Singleton {
		const APP_NAME    = 'woocommerce-pdf-invoices-packing-slips-extend-TC';
		const KEBAB       = 'woocommerce-pdf-invoices-packing-slips-extend-TC';
		const SNAKE       = 'woocommerce_pdf_invoices_packing_slips_extend_TC';
		const GITHUB_REPO = 'https://github.com/j7-dev/woocommerce-pdf-invoices-packing-slips-extend-TC';
